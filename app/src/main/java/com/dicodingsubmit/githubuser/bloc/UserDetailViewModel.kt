...
class UserDetailViewModel(application: Application) : ViewModel() {
	...
	fun insert(note: FavEntity) = mFavRepo.insert(note)

	fun deleteFav(note: FavEntity) = mFavRepo.delete(note)

	fun getAllFav() = mFavRepo.getFav()

	fun getFavById(id: String) = mFavRepo.getById(id)
	...
	class Factory(private val application: Application) : ViewModelProvider.Factory {
		...
		override fun <T : ViewModel> create(modelClass: Class<T>): T =
			UserDetailViewModel(application) as T
